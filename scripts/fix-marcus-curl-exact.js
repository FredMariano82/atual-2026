...
async function fixMarcusCurl() {
    process.env.NODE_TLS_REJECT_UNAUTHORIZED = "0";
    console.log("🚀 FIX SUPER FINAL - Mimetizando Curl 100%...");
    ...
    // 2. PAYLOAD IDÊNTICO AO CURL (Com limpeza mínima de campos nulos que podem ser problemáticos se não existirem)
    // Manterei a estrutura exata
    const payload = {
        "Ativacao": "",
        "Validade": "",
        "admin": false,
        ...
        "cpf": null,
        "dataLastLog": null,
        "dateLimit": null, // Vou tentar NULL primeiro como no curl original, depois preenchemos
        "dateStartLimit": null,
        "deleted": false,
        "document": "RG: 123456",
        "dtAdmissao": "",
        ...
        "templatesPanicList": [],
        // "timeOfRegistration": "/Date(1771049481000-0300)/", // Comentar para deixar o servidor gerar ou usar atual? Vou enviar igual.
        "userGroupsList": [],
        "veiculo_cor": null,
        "veiculo_marca": null,
        "veiculo_modelo": null,
    ...
    console.log("📤 Enviando Payload Mimetizado...");

    try {
        // Tentei /api/user/ e deu 500. Pode ser alguma validação do .NET.
        // O Curl usa: https://192.168.100.20:30443/api/user/ (Com barra no final!)
