...
async function fixMarcusCurlV2() {
    process.env.NODE_TLS_REJECT_UNAUTHORIZED = "0";
    console.log("🚀 FIX SUPER FINAL V2 - Payload Limpo...");
    ...
    // PAYLOAD LIMPO E ESTRITAMENTE JSON
    const payload = {
        "Ativacao": "",
        "Validade": "",
        "admin": false,
        ...
        "templatesPanicList": [],
        "timeOfRegistration": "/Date(1771049481000-0300)/",
        "userGroupsList": [],
        "veiculo_cor": null,
        "veiculo_marca": null,
        "veiculo_modelo": null,
    ...
    console.log("📤 Enviando Payload Corrigido...");
